...
7. Report back to the user with a 5-line summary: what area, how many
   files read, how many `[INFERRED]` tags, how many findings. Stop.
   Wait for the user to review and tell you to proceed to the next
   area.
